...
private:
	...
	Score SW_Score(char const * const scaff, char const * const read, int * result, int corr_length, MatrixElement * mat_pointer, int readId);

	bool Backtracking_CIGAR(char const * const scaff, char const * const read,
			int *& result, int *& alignments, int corr_length, int read_length, int alignment_length, MatrixElement * mat_pointer, int readId);
